...
;borra la linea que esta completa y recursivamente acomoda  las filas superiores de la rejilla uno hacia abajo para hacer el efecto de borrado de linea
...
(define (figura1 x1 x2 y1 y2 key);dibuja la figura recursivamente y muestra el efecto de caida teniendo en cuenta que controla el movimiento hacia los lados
...
(define (caida-fig1  x1 x2 y1 y2);valida que la persona pueda seguir jugando y llama a la funcion figura1 que me controla el efecto de caida de la figura 1
...
(define (caida-fig2  y1 x1 x2 x3 x4);valida que la persona pueda seguir jugando y llama a la funcion fig2 que me controla el efecto de caida de la figura 2
...
(define (caida-fig3 y1 y2 y3 y4 x1);valida que la persona pueda seguir jugando y llama a la funcion fig2 que me controla el efecto de caida de la figura 2
...
(define (caida-fig4  y1 y2 y3 x1 x2);valida que la persona pueda seguir jugando y llama a la funcion fig2 que me controla el efecto de caida de la figura 2
